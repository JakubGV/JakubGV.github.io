    ...
    <>
      <div className="grid-container">
        ...
        <div className="about-icons">
          <img src={htmlIcon} width="125"/>
          <img src={cssIcon} width="125"/>
          <img src={jsIcon} width="125"/>
          <img src={reactIcon} width="125"/>
          <img src={pythonIcon} width="125"/>
          <img src={sqlIcon} width="125"/>
        </div>
        ...
        <footer className="footer">
          ...
          <p className="footer-text">jakub.vogel@rutgers.edu</p>
